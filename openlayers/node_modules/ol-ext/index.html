    ...
    <div>
      ...
      <div class="example" data-date="2021-05-21">
        <a class="mainlink" href="examples/layer/map.layer.idw.html">
          <strong>IWD interpolated source</strong><br>
        </a>
        <p class="description"><i>ol/source/IWD</i> is an IWD interpolated source.</p>
        <p class="tag">layer, source, IWD, interpolation, inverse, distance, weight</p>
      </div>
